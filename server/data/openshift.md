mongoimport -u admin -p bKwaSRmGJphJ --host 127.0.0.1 --port 60911 --db sander --collection projects --drop --file server/data/min/commercial/condo-courtyard.min.json &&
